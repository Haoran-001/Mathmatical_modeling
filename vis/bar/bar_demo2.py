...
timeline.render("vis/bar/finance_indices_2002.html")
...
bar.overlap(line).render("vis/bar/mixed_bar_and_line.html")
...
bar.overlap(line).render("vis/bar/multiple_y_axes.html")
...
c = (
    ...
    .render("vis/bar/stack_bar_percent.html")
)